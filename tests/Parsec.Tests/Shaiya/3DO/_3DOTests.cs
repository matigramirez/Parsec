...
public class _3DOTests
{
    ...
    public void _3DOReadWriteTest()
    {
        ...
        var obj = ParsecReader.ReadFromFile<Parsec.Shaiya._3do._3do>(filePath);
        ...
        var objFromJson = ParsecReader.ReadFromJsonFile<Parsec.Shaiya._3do._3do>(jsonPath);
        ...
        var newObj = ParsecReader.ReadFromFile<Parsec.Shaiya._3do._3do>(newObjPath);
