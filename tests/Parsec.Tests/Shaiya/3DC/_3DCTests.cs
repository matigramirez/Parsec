...
public class _3DCTests
{
    ...
    public void _3DCReadWriteEP5Test()
    {
        ...
        var obj = ParsecReader.ReadFromFile<Parsec.Shaiya._3dc._3dc>(filePath);
        ...
        var objFromJson = ParsecReader.ReadFromJsonFile<Parsec.Shaiya._3dc._3dc>(jsonPath);
        ...
        var newObj = ParsecReader.ReadFromFile<Parsec.Shaiya._3dc._3dc>(newObjPath);
