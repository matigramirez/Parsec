...
public class NpcQuestTests
{
    ...
    public void NpcQuestEp5Test()
    {
        ...
        var npcQuest = ParsecReader.FromFile<Parsec.Shaiya.NpcQuest.NpcQuest>(filePath);
        npcQuest.Write(outputPath, Episode.EP5);
        npcQuest.WriteJson(jsonPath);

        var outputNpcQuest = ParsecReader.FromFile<Parsec.Shaiya.NpcQuest.NpcQuest>(outputPath);
        var jsonNpcQuest = ParsecReader.FromJsonFile<Parsec.Shaiya.NpcQuest.NpcQuest>(jsonPath);
    ...
    public void NpcQuestEp6Test()
    {
        ...
        var npcQuest = ParsecReader.FromFile<Parsec.Shaiya.NpcQuest.NpcQuest>(filePath, Episode.EP6);
        npcQuest.Write(outputPath, Episode.EP6);
        npcQuest.WriteJson(jsonPath);

        var outputNpcQuest = ParsecReader.FromFile<Parsec.Shaiya.NpcQuest.NpcQuest>(outputPath, Episode.EP6);
        var jsonNpcQuest = ParsecReader.FromJsonFile<Parsec.Shaiya.NpcQuest.NpcQuest>(jsonPath);
    ...
    public void NpcQuestEp8Test()
    {
        ...
        var npcQuest = ParsecReader.FromFile<Parsec.Shaiya.NpcQuest.NpcQuest>(filePath, Episode.EP8);
        npcQuest.Write(outputPath, Episode.EP8);
        npcQuest.WriteJson(jsonPath);

        var outputNpcQuest = ParsecReader.FromFile<Parsec.Shaiya.NpcQuest.NpcQuest>(outputPath, Episode.EP8);
        var jsonNpcQuest = ParsecReader.FromJsonFile<Parsec.Shaiya.NpcQuest.NpcQuest>(jsonPath);
    ...
    public void NpcQuestTranslationTest()
    {
        ...
        var npcQuest = ParsecReader.FromFile<NpcQuestTrans>(filePath);
        npcQuest.Write(outputPath);
        npcQuest.WriteJson(jsonPath);

        var outputNpcQuest = ParsecReader.FromFile<NpcQuestTrans>(outputPath);
        var jsonNpcQuest = ParsecReader.FromJsonFile<NpcQuestTrans>(jsonPath);
