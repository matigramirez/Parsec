...
public class _3DETests
{
    ...
    public void _3DEReadWriteTest()
    {
        ...
        var obj = ParsecReader.FromFile<Parsec.Shaiya._3de._3de>(filePath);
        ...
        var objFromJson = ParsecReader.FromJsonFile<Parsec.Shaiya._3de._3de>(jsonPath);
        ...
        var newObj = ParsecReader.FromFile<Parsec.Shaiya._3de._3de>(newObjPath);
